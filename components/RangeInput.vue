<template>
    <div ref="slider" mt-4 relative>
        ...
        <div class="flex justify-between items-center py-5">
            <div>
                <input type="text" maxlength="5"  v-model="minValue" class="px-3 py-2 border border-gray-200 rounded w-24 text-center text-black">
            </div>
            <div>
                <input type="text" maxlength="5"  v-model="maxValue" class="px-3 py-2 border border-gray-200 rounded w-24 text-center text-black">
            </div>
        </div>
    </div>
